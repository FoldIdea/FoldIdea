...
class BaseUnitsControllerTest < ActionController::TestCase
  ...
  test "should create base_unit" do
    assert_difference('BaseUnit.count') do
      post :create, base_unit: { base_length: @base_unit.base_length, base_width: @base_unit.base_width, name: @base_unit.name }
    end
  ...
  test "should update base_unit" do
    patch :update, id: @base_unit, base_unit: { base_length: @base_unit.base_length, base_width: @base_unit.base_width, name: @base_unit.name }
    assert_redirected_to base_unit_path(assigns(:base_unit))
  end
